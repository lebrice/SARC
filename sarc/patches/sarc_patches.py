"""
Collection of patches that need to be applied to the raw data from SARC before it can be returned to the client.

The functions here should be called by the sarc server before the data is returned to the client.
